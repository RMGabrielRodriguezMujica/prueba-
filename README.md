...
* **Gestión de Accesos:** Asignación de permisos de escritura (Write) a los desarrolladores y al revisor de código del equipo "Seguidores de Líneas Creativas".
* **Integración Final:** Responsable de ejecutar los "Squash and merge" en GitHub una vez aprobados los Pull Requests, manteniendo el historial de commits ordenado, y actualización del entorno local (`git pull origin main`).

### 💻 Gbariel Rodriguez 2 - Desarrollador 1
**Contribución en el Proyecto:**
